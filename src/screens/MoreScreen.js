...
const MoreScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={{ paddingTop: insets.top, paddingBottom: 20 + insets.bottom }}>
        {/* Profile Section */}
        <TouchableOpacity 
        ...
        {/* Premium Upgrade Button for Free Tier */}
        {isFreeTier && (
          <TouchableOpacity 
          ...
          >
            ...
            <View style={styles.premiumUpgradeContent}>
              ...
              <Text style={styles.premiumUpgradeSubtitle}>Unlock all features</Text>
            </View>
