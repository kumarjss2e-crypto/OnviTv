...
const PremiumUpgradeScreen = ({ navigation, onSkip, onUpgrade, isModal = true }) => {
  ...
  return (
    <SafeAreaView style={[styles.container, isModal && styles.containerModal]}>
      <LinearGradient
      ...
      >
        ...
        >
          {/* Header */}
          <View style={[styles.header, { paddingTop: isModal ? 24 : 16 }]}>
        ...
        <View style={styles.comparisonSection}>
          ...
          <View style={styles.comparisonTable}>
            <View style={[styles.comparisonRow, styles.comparisonHeader]}>
              ...
              <Text style={[styles.comparisonValue, styles.headerText]}>Free</Text>
              <Text style={[styles.comparisonValue, styles.headerText]}>Premium</Text>
            </View>
            ...
            {[
              ...
              { feature: 'Downloads', free: 'None', premium: 'Unlimited' },
      ...
      <View style={[styles.buttonContainer, { paddingBottom: insets.bottom + 12, paddingTop: 12 }]}>
        <TouchableOpacity
